...
<head>
    ...
    <title><?php echo e($title ?? 'Electro.bd — Premium Electronics Components Store'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <span class="flex items-center gap-1">
                    ...
                    <?php echo e(\App\Models\Setting::get('support_phone', '+8801XXXXXXXXX')); ?>

                </span>
                <span class="flex items-center gap-1">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                    <?php echo e(\App\Models\Setting::get('support_email', 'support@electro.bd')); ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3316940229-0', $__key);
...
?>
                ...
                <div class="flex items-center gap-2 md:gap-4">
                    ...
                    <a href="<?php echo e(route('wishlist')); ?>" class="hidden md:flex items-center gap-1.5 text-gray-600 hover:text-[var(--color-soft-coral)] transition-colors p-2">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3316940229-1', $__key);
        ...
        <nav class="hidden md:block border-t border-gray-50 bg-white">
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center gap-6 h-11 text-sm">
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="grid grid-cols-3 gap-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Category::parents()->active()->ordered()->with('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div>
                                        <a href="<?php echo e(route('shop', ['category' => $cat->slug])); ?>" class="font-semibold text-[var(--color-text-primary)] hover:text-[var(--color-trust-blue)] flex items-center gap-2 mb-2">
                                            <span><?php echo e($cat->icon); ?></span> <?php echo e($cat->name); ?>

                                        </a>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cat->children->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <a href="<?php echo e(route('shop', ['category' => $child->slug])); ?>" class="block text-sm text-gray-500 hover:text-[var(--color-trust-blue)] py-0.5 pl-6">
                    ...
                    <a href="<?php echo e(route('shop', ['flash_sale' => true])); ?>" class="text-[var(--color-warm-orange)] font-semibold hover:text-[var(--color-warm-orange-hover)] transition-colors flex items-center gap-1">
                        ⚡ Flash Sale
                    </a>
                    <a href="<?php echo e(route('shop', ['featured' => true])); ?>" class="text-gray-600 hover:text-[var(--color-trust-blue)] transition-colors">
                        Featured
                    </a>
                    <a href="<?php echo e(route('shop')); ?>" class="text-gray-600 hover:text-[var(--color-trust-blue)] transition-colors">
                        New Arrivals
                    </a>
                </div>
            </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3316940229-2', $__key);
...
?>
    ...
    <footer class="bg-[var(--color-text-primary)] text-white mt-auto">
        <div class="max-w-7xl mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li><a href="<?php echo e(route('shop')); ?>" class="hover:text-white transition-colors">Shop</a></li>
                        <li><a href="<?php echo e(route('home')); ?>#flash-sales" class="hover:text-white transition-colors">Flash Sale</a></li>
            ...
            <div class="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-500">
                © <?php echo e(date('Y')); ?> Electro.bd — All Rights Reserved.
            </div>
        </div>
    </footer>
    ...
    <nav class="mobile-nav md:hidden">
        ...
        <a href="<?php echo e(route('cart')); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('cart') ? 'active' : ''); ?> relative">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z"/></svg>
            <span>Cart</span>
        </a>
        <a href="<?php echo e(route('wishlist')); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('wishlist') ? 'active' : ''); ?>">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
            <span>Wishlist</span>
        </a>
        <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>" class="mobile-nav-item">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
            <span>Profile</span>
        </a>
    </nav>
    ...
    <a href="https://wa.me/<?php echo e(str_replace('+', '', \App\Models\Setting::get('whatsapp_number', '8801XXXXXXXXX'))); ?>"
       target="_blank" rel="noopener"
       class="fixed bottom-20 md:bottom-6 right-4 md:right-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 hover:scale-110 transition-all duration-300 z-30">
...
<?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\electro-bd\resources\views\layouts\app.blade.php ENDPATH**/ ?>