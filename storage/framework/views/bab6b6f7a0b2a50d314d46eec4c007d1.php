    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wishlistItems->isEmpty()): ?>
            <div class="bg-white p-12 rounded-xl shadow-sm border border-gray-100 text-center">
                ...
                <a href="<?php echo e(route('shop')); ?>" class="btn btn-primary inline-flex">কেনাকাটা শুরু করুন</a>
            </div>
        <?php else: ?>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden group">
                            <div class="relative h-48 bg-gray-100 p-4 flex items-center justify-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product->cover_image): ?>
                                    <img src="<?php echo e(Storage::url($item->product->cover_image)); ?>" alt="<?php echo e($item->product->name); ?>" class="max-h-full object-contain">
                                <?php else: ?>
...
</div><?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\electro-bd\resources\views\livewire\wishlist.blade.php ENDPATH**/ ?>