...
<?php endif; ?>
    ...
    <div class="max-w-[1600px] w-full mx-auto px-2 md:px-4 xl:px-[70px] pb-20 pt-0 md:pt-8">
        <form id="checkout-form" wire:submit.prevent="placeOrder" class="grid grid-cols-1 lg:grid-cols-12 gap-4 bg-white p-0">
            ...
            <div class="lg:col-span-4 flex justify-start items-start">
                <img src="<?php echo e($product->cover_image_url); ?>" alt="<?php echo e($product->name); ?>" class="w-full object-contain mix-blend-multiply">
            </div>

            
            <div class="lg:col-span-4 flex flex-col">
                <h1 class="text-[26px] font-bold text-gray-900 leading-snug mb-1"><?php echo e($product->name); ?></h1>
                ...
                <div class="flex flex-col gap-1.5 mb-2 mt-2 text-[13px] text-gray-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->sku): ?>
                        <div class="flex items-center">
                            ...
                            <span class="font-bold text-gray-900"><?php echo e($product->sku); ?></span>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="flex items-center">
                        <span class="w-20 font-medium">Brand</span>
                        <span class="mr-2">:</span>
                        <span class="font-bold text-[#094d82] uppercase"><?php echo e($product->brand->name ?? 'TOMZN'); ?></span>
                    </div>
                    <div class="flex items-center">
                        <span class="w-20 font-medium">Warranty</span>
                        <span class="mr-2">:</span>
                        <span class="font-bold text-gray-900"><?php echo e($product->warranty ?? '15 Days'); ?></span>
                    </div>
                </div>
                
                <div class="flex items-center gap-3 mb-3 mt-1">
                    <span class="text-[28px] font-extrabold text-[#f97316]">৳<?php echo e(number_format($product->effective_price, 0)); ?></span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price && $product->discount_price < $product->regular_price): ?>
                        <span class="text-sm text-gray-400 line-through">৳<?php echo e(number_format($product->regular_price, 0)); ?></span>
                        <span class="bg-green-100 text-green-700 px-2 py-0.5 rounded text-[11px] font-bold">
                            Save ৳<?php echo e(number_format($product->regular_price - $product->effective_price, 0)); ?>
                ...
                <div class="mb-2 flex items-center justify-between border border-[#9ca3af] rounded-lg p-2 w-full">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-sm font-bold text-green-600 w-4 text-center"><?php echo e($quantity); ?></span>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-[10px] block -mt-1 mb-2"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="border border-gray-100 rounded-2xl p-4 pt-3 shadow-[0_0_15px_rgba(0,0,0,0.03)] bg-white relative overflow-visible">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4 relative z-10">
                        <label class="cursor-pointer relative w-full">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($delivery_area === 'inside_dhaka'): ?>
                        ...
                        <label class="cursor-pointer relative w-full">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($delivery_area === 'outside_dhaka'): ?>
                                <div class="absolute -top-[9px] right-2 w-[18px] h-[18px] bg-[#094d82] rounded-full flex items-center justify-center text-white border-2 border-white shadow-sm z-10">
                                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mb-3 border border-gray-200 rounded-lg p-4">
                        <div class="flex gap-2.5 items-center border-b border-gray-100 pb-3 mb-3">
                            <img src="<?php echo e($product->cover_image_url); ?>" alt="<?php echo e($product->name); ?>" class="w-9 h-9 object-cover rounded shadow-sm border border-gray-50">
                            <div class="flex-1">
                                <h4 class="text-[11px] font-semibold text-gray-800 line-clamp-2 leading-tight"><?php echo e($product->name); ?></h4>
                                <div class="text-[10px] text-[#28a745] font-bold mt-0.5"><?php echo e($quantity); ?>x</div>
                            </div>
                            <div class="font-bold text-gray-900 text-[13px] shrink-0">৳<?php echo e(number_format($product->effective_price * $quantity, 0)); ?></div>
                        </div>

                        <div class="space-y-1.5 text-[12px] text-gray-400 font-medium mb-3">
                            <div class="flex justify-between">
                                <span>Subtotal</span>
                                <span class="text-gray-800">৳<?php echo e(number_format($product->effective_price * $quantity, 0)); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span>Delivery Charge</span>
                                <span class="text-gray-800">৳<?php echo e($delivery_charge); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="pt-3 flex justify-between items-center border-t border-gray-100 mt-3">
                            ...
                            <span class="text-[20px] font-extrabold text-[#f97316]">৳<?php echo e(number_format(($product->effective_price * $quantity) + $delivery_charge + $this->upsell_total, 0)); ?></span>
                        </div>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($suggested_products && count($suggested_products) > 0): ?>
                    <div class="mb-2">
                        <h3 class="font-bold text-gray-900 mb-3 text-[17px]">Best Match For Your Order</h3>
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $suggested_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upsell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <label class="flex items-center gap-3 cursor-pointer group border border-gray-200 rounded-2xl p-3.5 hover:border-[#094d82] transition-all bg-white <?php echo e(in_array($upsell->id, $upsell_products ?? []) ? '!border-[#094d82] shadow-sm bg-[#f0f6fa]' : ''); ?>">
                                    <input type="checkbox" wire:model.live="upsell_products" value="<?php echo e($upsell->id); ?>" class="peer sr-only">
                                    ...
                                    <img src="<?php echo e($upsell->cover_image_url); ?>" alt="<?php echo e($upsell->name); ?>" class="w-8 h-8 object-contain rounded shrink-0">
                                    <div class="flex-1 pr-2 min-w-0">
                                        <div class="text-[11px] font-semibold text-gray-700 leading-tight mb-0.5 group-hover:text-[#28a745] transition-colors line-clamp-2 overflow-hidden" title="<?php echo e($upsell->name); ?>"><?php echo e($upsell->name); ?></div>
                                    </div>
                                    <div class="text-[12px] font-bold text-[#28a745] whitespace-nowrap shrink-0 flex flex-col items-end">
                                        ৳<?php echo e(number_format($upsell->effective_price, 0)); ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($upsell->discount_price): ?>
                                            <span class="text-[8px] font-bold text-blue-500 border border-blue-200 rounded-[3px] px-1 bg-blue-50 mt-0.5">Save ৳<?php echo e(number_format($upsell->regular_price - $upsell->effective_price, 0)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </label>
                                            ...
                                            <tbody>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $leftSpecs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <tr class="border-b border-gray-100 last:border-b-0">
                                                        <th class="w-2/5 px-4 py-3 font-semibold text-gray-700 bg-gray-50 border-r border-gray-100 align-top"><?php echo e($key); ?></th>
                                                        <td class="px-4 py-3 text-gray-600 align-top"><?php echo e($value); ?></td>
                                                    </tr>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </tbody>
                                        </table>
    ...
    <div class="md:hidden fixed bottom-0 left-0 w-full bg-white/75 backdrop-blur-md border-t border-white/50 px-4 py-1.5 shadow-[0_-4px_15px_-1px_rgba(0,0,0,0.08)] z-[60] flex items-center justify-between">
        <div class="text-[15px] font-bold text-gray-800 flex items-center gap-1.5">
            Total: <span class="text-[19px] text-[#f97316]">৳<?php echo e(number_format(($product->effective_price * $quantity) + $delivery_charge + $this->upsell_total, 0)); ?></span>
        </div>
...
<script>
    ...
    ?>
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views/livewire/landing-page.blade.php ENDPATH**/ ?>