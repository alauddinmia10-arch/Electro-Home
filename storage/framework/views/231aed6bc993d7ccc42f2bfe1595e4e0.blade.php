            ...
            <span class="inline-flex items-center">
                ...
                <span class="inline-flex items-center my-custom-btns" style="font-size: 1rem; font-weight: 500;">
                    ...
                    <x-filament::button tag="a" href="{{ \App\Filament\Resources\Categories\CategoryResource::getUrl('create') }}" color="stat_green" icon="heroicon-o-plus-circle" style="background-color: #16a34a !important; border-color: #16a34a !important;">Add Category</x-filament::button>
                    <x-filament::button tag="a" href="{{ \App\Filament\Resources\Products\ProductResource::getUrl('create') }}" color="info" icon="heroicon-o-plus-circle" style="background-color: #3b82f6 !important; border-color: #3b82f6 !important;">Add Product</x-filament::button>
                </span>
            </span>
            <style>
