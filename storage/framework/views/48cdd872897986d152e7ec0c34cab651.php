...
<div class="space-y-4">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center gap-3">
                    <div class="flex items-center border border-gray-200 rounded-lg bg-white overflow-hidden w-32 h-11 shrink-0">
                        <button wire:click="decrement" class="px-3 py-2 text-gray-600 hover:bg-gray-50 transition-colors h-full flex items-center justify-center" <?php if($quantity <= 1): ?> disabled <?php endif; ?>>
                        ...
                        <button wire:click="increment" class="px-3 py-2 text-gray-600 hover:bg-gray-50 transition-colors h-full flex items-center justify-center" <?php if($quantity >= $stockQuantity): ?> disabled <?php endif; ?>>
    ...
    <?php if (! $__env->hasRenderedOnce('d054c947-f190-4609-82a2-03bd7d093b2b')): $__env->markAsRenderedOnce('d054c947-f190-4609-82a2-03bd7d093b2b'); ?>
    <style>
    ...
    <?php endif; ?>
</div><?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\electro-bd\resources\views\livewire\add-to-cart.blade.php ENDPATH**/ ?>