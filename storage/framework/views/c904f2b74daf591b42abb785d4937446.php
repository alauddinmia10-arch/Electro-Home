        ...
        <div class="flex flex-col lg:flex-row gap-2 lg:gap-8">
                ...
                <div class="bg-transparent md:bg-white md:rounded md:shadow-sm md:border md:border-gray-200 overflow-hidden">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($items->count() > 0): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'cart-item-'.e($item->product_id).''; ?>wire:key="cart-item-<?php echo e($item->product_id); ?>" x-data="{ 
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <span wire:ignore class="font-bold text-price text-lg" x-text="'৳' + new Intl.NumberFormat('en-US').format(<?php echo e($item->product->effective_price); ?> * qty)">৳<?php echo e(number_format($item->product->effective_price * $item->quantity, 0)); ?></span>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                        ...
                        <div class="block md:hidden space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="bg-white rounded-md shadow-sm border border-gray-200 p-2 space-y-2" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'mobile-cart-item-'.e($item->product_id).''; ?>wire:key="mobile-cart-item-<?php echo e($item->product_id); ?>" x-data="{ 
                                    qty: <?php echo e($quantities[$item->product_id] ?? 1); ?>, 
                                    stock: <?php echo e($item->product->stock_quantity ?? 999); ?>,
                                    timeout: null,
                                    updateQty(change, price) {
                                    ...
                                    <div class="flex items-start justify-between gap-2">
                                        <a href="<?php echo e(route('product.show', $item->product->slug)); ?>" class="shrink-0 bg-white rounded border border-gray-100 overflow-hidden block p-1" style="width: 72px; height: 72px;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product->cover_image_url): ?>
                                                <img src="<?php echo e($item->product->cover_image_url); ?>" alt="<?php echo e($item->product->name); ?>" class="w-full h-full object-contain mix-blend-multiply">
                                            <?php else: ?>
                                                <div class="w-full h-full flex items-center justify-center text-gray-300">
                                        ...
                                        <div class="flex-1 min-w-0 pt-0.5">
                                            <a href="<?php echo e(route('product.show', $item->product->slug)); ?>" class="font-bold text-gray-800 text-[19px] leading-snug line-clamp-2 hover:text-[var(--color-trust-blue)]">
                                                <?php echo e($item->product->name); ?>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product->sku): ?>
                                                <div class="text-[14px] text-gray-400 mt-1 font-mono">SKU: <?php echo e($item->product->sku); ?></div>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>

                                        <button wire:click="removeItem(<?php echo e($item->product_id); ?>)" class="text-gray-400 hover:text-red-500 p-1 shrink-0 transition-colors" title="Remove Item">
                                    ...
                                    <div class="space-y-1.5 pt-1 pr-3" style="padding-left: 80px;">
                                        ...
                                        <div class="flex justify-between items-center text-sm">
                                            ...
                                            <span class="font-semibold text-gray-700 text-[18px]">৳<?php echo e(number_format($item->product->effective_price, 0)); ?></span>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center text-sm">
                                            ...
                                            <div class="inline-flex items-center border border-gray-200 rounded-md bg-white overflow-hidden shadow-2xs px-1.5" style="width: 110px; height: 42px;">
                                                <button type="button" @click="updateQty(-1, <?php echo e($item->product->effective_price); ?>)" class="w-7 h-full text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors font-bold text-base flex items-center justify-center shrink-0 rounded" :disabled="qty <= 1">−</button>
                                                ...
                                                <button type="button" @click="updateQty(1, <?php echo e($item->product->effective_price); ?>)" class="w-7 h-full text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors font-bold text-base flex items-center justify-center shrink-0 rounded" :disabled="qty >= stock">+</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center text-sm pt-1.5 border-t border-gray-100">
                                            ...
                                            <span wire:ignore class="font-bold text-price text-[22px]" x-text="'৳' + new Intl.NumberFormat('en-US').format(<?php echo e($item->product->effective_price); ?> * qty)">৳<?php echo e(number_format($item->product->effective_price * $item->quantity, 0)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="p-12 text-center flex flex-col items-center justify-center bg-white rounded shadow-sm border border-gray-200">
                            ...
                            <a href="<?php echo e(route('shop')); ?>" class="btn btn-primary px-8 !bg-[#1f618d] hover:!bg-[#174a6c] border-none">শপিং শুরু করুন</a>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($items->count() > 0): ?>
                <div class="w-full lg:w-96 shrink-0">
                    <div class="bg-white rounded-md shadow-sm border border-gray-200 p-3 md:p-6 sticky top-24" x-data="{ orderSubtotal: <?php echo e($subtotal); ?>, orderQty: <?php echo e($items->sum('quantity')); ?> }" @cart-updated-optimistic.window="orderSubtotal += $event.detail.amount; orderQty += $event.detail.qty_change" @cart-updated.window="if($event.detail.subtotal !== undefined) { orderSubtotal = $event.detail.subtotal; orderQty = $event.detail.count; }">
                        ...
                        <div class="border-t border-gray-100 pt-4 mb-5 flex justify-between items-end">
                            ...
                            <span class="text-[26px] md:text-2xl font-bold text-price" wire:ignore x-text="'৳' + new Intl.NumberFormat('en-US').format(orderSubtotal)">৳<?php echo e(number_format($subtotal, 0)); ?></span>
                        </div>

                        <a href="<?php echo e(route('checkout')); ?>" class="btn w-full py-2.5 md:py-3 text-[22px] md:text-lg flex justify-center items-center gap-2 bg-[#1f618d] hover:bg-[#174a6c] text-white font-bold antialiased transition-colors border-none rounded">
                        ...
                        <a href="<?php echo e(route('shop')); ?>" class="block text-center text-[var(--color-trust-blue)] hover:underline mt-4 text-[18px] md:text-sm font-semibold">
...
</div><?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views\livewire/cart-page.blade.php ENDPATH**/ ?>