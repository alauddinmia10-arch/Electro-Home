...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="max-w-[1600px] w-full mx-auto px-0 md:px-2 md:px-4 xl:px-[70px] mt-1">
    ...
    <div class="max-w-[1600px] w-full mx-auto px-0 md:px-2 md:px-4 xl:px-[70px] mt-1 mb-6" x-data="{ wholesaleModalOpen: false }">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6">
            ...
            <div x-data="{ mainImage: '<?php echo e($product->cover_image_url); ?>' }" class="lg:col-span-5 flex flex-col md:flex-row gap-3 md:gap-0 -ml-2 lg:-ml-6">
                    ...
                    <div class="order-2 md:order-1 w-full md:w-[80px] shrink-0" x-data="{
                        ...
                        <div class="relative bg-white md:bg-transparent rounded p-0 shadow-sm md:shadow-none border border-gray-100 md:border-none flex flex-col justify-start">
                            ...
                            <div x-ref="thumbSlider" class="flex md:flex-col gap-2 overflow-auto scrollbar-hide md:max-h-[432px] snap-x md:snap-y w-full">
                                <button @click="mainImage = '<?php echo e($product->cover_image_url); ?>'" 
                                        class="w-16 h-16 md:w-[80px] md:h-[80px] shrink-0 bg-white rounded border-2 overflow-hidden snap-start transition-all"
                                        :class="mainImage === '<?php echo e($product->cover_image_url); ?>' ? 'border-[#1a5b82]' : 'border-gray-200 hover:border-gray-400'">
                                    <img src="<?php echo e($product->cover_image_url); ?>" class="w-full h-full object-cover mix-blend-multiply">
                                </button>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <button @click="mainImage = '<?php echo e($image->image_url); ?>'" 
                                            class="w-16 h-16 md:w-[80px] md:h-[80px] shrink-0 bg-white rounded border-2 overflow-hidden snap-start transition-all"
                                            :class="mainImage === '<?php echo e($image->image_url); ?>' ? 'border-[#1a5b82]' : 'border-gray-200 hover:border-gray-400'">
                                        <img src="<?php echo e($image->image_url); ?>" class="w-full h-full object-cover mix-blend-multiply">
                                    </button>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3757254381-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3757254381-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3757254381-2', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3757254381-3', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3757254381-4', $__key);
...
<?php endif; ?>
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views/product/show.blade.php ENDPATH**/ ?>