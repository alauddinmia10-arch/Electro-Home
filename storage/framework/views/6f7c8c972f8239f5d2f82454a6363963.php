...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2866345180-0', $__key);
...
?>
    ...
    <a href="<?php echo e(route('product.show', $product->slug)); ?>" class="product-image block aspect-square bg-white relative">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->cover_image_url): ?>
            <img src="<?php echo e($product->cover_image_url); ?>" alt="<?php echo e($product->name); ?>" loading="lazy">
        <?php else: ?>
...
[$__name, $__params] = $__split('product-card-add-to-cart', ['product' => $product,'button-class' => request('cols') == 6 ? 'gap-1 px-1 text-[13px]' : 'gap-2 px-2.5 text-[15px]','svg-class' => request('cols') == 6 ? 'w-4 h-4' : 'w-4 h-4']);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2866345180-1', $__key);
...
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views/partials/product-card.blade.php ENDPATH**/ ?>