            ...
            <div class="w-full md:w-1/4">
                <div class="bg-white rounded shadow-sm border border-gray-100 overflow-hidden sticky top-20">
                    ...
                    <div class="flex flex-col p-2">
                        <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-3 text-trust-blue font-medium bg-blue-50 rounded flex items-center gap-3">
                        ...
                        <a href="<?php echo e(route('wishlist')); ?>" class="px-4 py-3 text-gray-600 hover:text-trust-blue hover:bg-gray-50 rounded flex items-center gap-3 transition-colors">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isStaff()): ?>
                            <a href="<?php echo e(url('/admin')); ?>" class="px-4 py-3 text-trust-blue font-bold hover:bg-gray-50 rounded flex items-center gap-3 transition-colors">
...
</div><?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views\livewire/dashboard.blade.php ENDPATH**/ ?>