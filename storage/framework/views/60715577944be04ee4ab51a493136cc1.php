        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="w-full md:w-1/4">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-20">
                    <div class="p-6 border-b border-gray-100 text-center">
                        ...
                        <h3 class="font-bold text-gray-800"><?php echo e(Auth::user()->name); ?></h3>
                        <p class="text-sm text-gray-500"><?php echo e(Auth::user()->phone); ?></p>
                    </div>
                    
                    <div class="flex flex-col p-2">
                        <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-3 text-trust-blue font-medium bg-blue-50 rounded-lg flex items-center gap-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                            আমার প্রোফাইল
                        </a>
                        <a href="#" class="px-4 py-3 text-gray-600 hover:text-trust-blue hover:bg-gray-50 rounded-lg flex items-center gap-3 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                            অর্ডার সমূহ
                        </a>
                        <a href="<?php echo e(route('wishlist')); ?>" class="px-4 py-3 text-gray-600 hover:text-trust-blue hover:bg-gray-50 rounded-lg flex items-center gap-3 transition-colors">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isStaff()): ?>
                            <a href="<?php echo e(url('/admin')); ?>" class="px-4 py-3 text-trust-blue font-bold hover:bg-gray-50 rounded-lg flex items-center gap-3 transition-colors">
                        ...
                        <button wire:click="logout" class="px-4 py-3 text-soft-coral hover:bg-red-50 rounded-lg flex items-center gap-3 transition-colors text-left w-full">
            ...
            <div class="w-full md:w-3/4 space-y-6">
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                    <h2 class="text-xl font-bold text-gray-800 font-bangla mb-4">স্বাগতম, <?php echo e(Auth::user()->name); ?>!</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo e(Auth::user()->orders()->count()); ?></h4>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo e(Auth::user()->orders()->where('delivery_status', 'pending')->count()); ?></h4>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center">
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo e(Auth::user()->wishlists()->count()); ?></h4>
...
</div><?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\electro-bd\resources\views\livewire\dashboard.blade.php ENDPATH**/ ?>