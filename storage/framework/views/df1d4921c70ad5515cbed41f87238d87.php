    ...
    <?php else: ?>
        <form wire:submit.prevent="submit">
            ...
            <div class="mb-4">
                ...
                <input type="text" value="<?php echo e(\App\Models\Product::find($productId)?->name); ?>" class="w-full px-3 py-2 border border-gray-300 rounded bg-gray-100 text-gray-600 focus:outline-none" disabled>
            </div>
...
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views/livewire/wholesale-request-component.blade.php ENDPATH**/ ?>