        ...
        <div class="max-w-[1600px] w-full mx-auto px-3 md:px-6 xl:px-[70px] flex items-center justify-between">
            <div class="flex items-center gap-4">
                <span class="flex items-center gap-1">
                    ...
                    <?php echo e(\App\Models\Setting::get('support_phone', '+8801880223099')); ?>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1170053293-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1170053293-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1170053293-2', $__key);
...
<?php endif; ?>
                ...
                <div class="col-span-1 lg:col-span-1 order-3 lg:order-2 justify-self-start lg:justify-self-center">
                    ...
                    <ul class="space-y-3.5 text-[15px] text-gray-600">
                        <li class="flex items-center gap-1.5">
                            ...
                            <a href="<?php echo e(route('shop')); ?>" class="hover:text-[#0b5c9a] transition-colors">Shop</a>
                        </li>
                        <li class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-[#0b5c9a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                            <a href="<?php echo e(route('home')); ?>#flash-sales" class="hover:text-[#0b5c9a] transition-colors">Flash Sale</a>
                        </li>
                        <li class="flex items-center gap-1.5">
                            <svg class="w-3.5 h-3.5 text-[#0b5c9a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                ...
                <div class="col-span-2 lg:col-span-1 order-2 lg:order-4 justify-self-start lg:justify-self-center w-full">
                    ...
                    <ul class="space-y-3 text-[15px] text-gray-600">
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="tel:<?php echo e(str_replace(' ', '', \App\Models\Setting::get('support_phone', '+8801880223099'))); ?>" class="group-hover:text-[#0b5c9a] group-hover:translate-x-1.5 transition-all duration-300"><?php echo e(\App\Models\Setting::get('support_phone', '+8801880223099')); ?></a>
                        </li>
                        <li class="flex items-center gap-2 group">
                            <svg class="w-4 h-4 text-[#0b5c9a] shrink-0 group-hover:scale-125 transition-transform duration-300" style="width: 16px; height: 16px;" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                            <a href="https://wa.me/<?php echo e(str_replace(['+', ' '], '', \App\Models\Setting::get('whatsapp_number', '8801880223099'))); ?>" target="_blank" class="group-hover:text-[#25D366] group-hover:translate-x-1.5 transition-all duration-300"><?php echo e(\App\Models\Setting::get('whatsapp_number', '8801880223099')); ?></a>
                        </li>
                        <li class="flex items-center gap-2 group">
                            <svg class="w-4 h-4 text-[#0b5c9a] shrink-0 group-hover:scale-125 transition-transform duration-300" style="width: 16px; height: 16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            <a href="mailto:<?php echo e(\App\Models\Setting::get('support_email', 'support@electrohome.bd')); ?>" class="group-hover:text-[#0b5c9a] group-hover:translate-x-1.5 transition-all duration-300"><?php echo e(\App\Models\Setting::get('support_email', 'support@electrohome.bd')); ?></a>
                        </li>
    ...
    <div class="fixed bottom-[90px] md:bottom-8 right-4 md:right-10 z-[70] flex flex-col items-center gap-2 md:gap-3 print:hidden">
        ...
        <a href="https://wa.me/<?php echo e(str_replace('+', '', \App\Models\Setting::get('whatsapp_number', '8801880223099'))); ?>"
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1170053293-3', $__key);
...
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\08-12-2026\ElectroHome.BD\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>