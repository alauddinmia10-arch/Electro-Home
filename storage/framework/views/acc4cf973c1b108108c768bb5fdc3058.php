...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1240286031-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1240286031-1', $__key);
        ...
        <nav class="hidden md:block border-t border-[#0b5c9a]/20 bg-[#0b5c9a]/15 backdrop-blur-md sticky top-0 z-40">
            <div class="max-w-[1440px] mx-auto px-4 xl:px-[70px]">
                <div class="flex items-center gap-6 h-9 text-sm">
                    ...
                    <a href="<?php echo e(route('shop')); ?>" class="text-gray-700 font-semibold hover:text-[#094d82] transition-colors">
                        Shop
                    </a>
                    <a href="<?php echo e(route('shop', ['featured' => true])); ?>" class="text-gray-700 font-semibold hover:text-[#094d82] transition-colors">
                        Featured
                    </a>
                    <a href="<?php echo e(route('shop', ['new_arrivals' => 1])); ?>" class="text-gray-700 font-semibold hover:text-[#094d82] transition-colors">
                        New Arrivals
                    </a>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1240286031-2', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1240286031-3', $__key);
...
<?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\ElectroHome.BD\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>