                            ...
                            <table class="w-full text-left">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <tr <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'cart-item-'.e($item->product_id).''; ?>wire:key="cart-item-<?php echo e($item->product_id); ?>">
                                            <td class="px-6 py-4">
                                                <div class="flex items-center gap-4">
                                                    <a href="<?php echo e(route('product.show', $item->product->slug)); ?>" class="w-16 h-16 shrink-0 bg-gray-50 rounded-lg border border-gray-100 overflow-hidden block">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="flex items-center justify-center">
                                                    <div class="flex items-center border border-gray-200 rounded bg-gray-50">
                                                        <button wire:click="updateQuantity(<?php echo e($item->product_id); ?>, <?php echo e($item->quantity - 1); ?>)" class="px-2 py-1 text-gray-500 hover:text-black hover:bg-gray-200 transition-colors" <?php if($item->quantity <= 1): ?> disabled <?php endif; ?>>-</button>
                                                        <input type="text" value="<?php echo e($item->quantity); ?>" class="w-10 text-center text-sm font-semibold bg-transparent border-x border-gray-200 py-1" readonly>
                                                        <button wire:click="updateQuantity(<?php echo e($item->product_id); ?>, <?php echo e($item->quantity + 1); ?>)" class="px-2 py-1 text-gray-500 hover:text-black hover:bg-gray-200 transition-colors">+</button>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <span class="font-bold text-[var(--color-trust-blue)] text-lg">৳<?php echo e(number_format($item->product->effective_price * $item->quantity, 0)); ?></span>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <button wire:click="removeItem(<?php echo e($item->product_id); ?>)" class="p-2 text-red-400 hover:bg-red-50 hover:text-red-600 rounded-lg transition-colors" title="Remove Item">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-24">
                        ...
                        <div class="space-y-4 text-sm text-gray-600 mb-6">
                            <div class="flex justify-between">
                                <span>Subtotal (<?php echo e($items->sum('quantity')); ?> items)</span>
                        ...
                        <div class="border-t border-gray-100 pt-4 mb-6 flex justify-between items-end">
                            ...
                            <span class="text-2xl font-bold text-price">৳<?php echo e(number_format($subtotal, 0)); ?></span>
                        </div>
...
</div><?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\electro-bd\resources\views\livewire\cart-page.blade.php ENDPATH**/ ?>