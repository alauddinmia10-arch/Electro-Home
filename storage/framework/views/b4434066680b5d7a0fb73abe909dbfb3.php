    ...
    <header class="bg-white sticky top-0 z-40 border-b border-gray-100" x-data="{ mobileMenu: false }">
        <div class="max-w-[1440px] mx-auto px-4 xl:px-[70px]">
            <div class="flex items-center justify-between h-16 md:h-18">
                ...
                <a href="<?php echo e(route('home', ['ref' => 'logo'])); ?>" class="flex items-center gap-2 shrink-0">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3279910250-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3279910250-1', $__key);
...
?>
                        ...
                        <div x-show="open" @click.outside="open = false" x-transition:enter="transition ease-out duration-200"
                            ...
                            <div class="grid grid-cols-3 gap-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Category::parents()->active()->ordered()->with('children')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div>
                                        <a href="<?php echo e(route('shop', ['category' => $cat->slug])); ?>" class="group font-semibold text-[var(--color-text-primary)] hover:text-[var(--color-trust-blue)] flex items-center gap-2 mb-2">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cat->icon): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_starts_with($cat->icon, 'heroicon-')): ?>
                                                    <?php echo e(svg($cat->icon, 'w-5 h-5 shrink-0 text-gray-500 group-hover:text-[var(--color-trust-blue)]')); ?>
                                                <?php else: ?>
                                                    <span class="shrink-0"><?php echo e($cat->icon); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div x-data="{ show: false }" @toggle-mobile-search.window="show = !show"
         x-show="show" x-cloak x-transition class="fixed inset-0 bg-white z-50 p-4 md:hidden">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3279910250-2', $__key);
...
?>
    ...
    <nav class="mobile-nav md:!hidden lg:!hidden">
        <a href="<?php echo e(route('home', ['ref' => 'mobile'])); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('cart', ['v' => 2])); ?>" class="mobile-nav-item <?php echo e(request()->routeIs('cart') ? 'active' : ''); ?> relative">
...
<?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\ElectroHome.BD\resources\views/layouts/app.blade.php ENDPATH**/ ?>