            ...
            <aside class="w-full md:w-64 shrink-0">
                <form action="<?php echo e(route('shop')); ?>" method="GET" id="filter-form" class="space-y-6 bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Search products..." class="w-full px-3 py-2 border border-gray-200 rounded-md text-sm focus:outline-none focus:border-[#0b5c9a]">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" name="min_price" value="<?php echo e(request('min_price')); ?>" placeholder="Min ৳" class="w-full px-3 py-2 border border-gray-200 rounded-md text-sm focus:outline-none focus:border-[#0b5c9a]">
                            <input type="number" name="max_price" value="<?php echo e(request('max_price')); ?>" placeholder="Max ৳" class="w-full px-3 py-2 border border-gray-200 rounded-md text-sm focus:outline-none focus:border-[#0b5c9a]">
                        </div>
                    </div>
