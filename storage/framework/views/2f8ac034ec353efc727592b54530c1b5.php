...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <section class="max-w-[1600px] w-full mx-auto px-2 md:px-4 xl:px-[70px]">
    ...
    <section id="flash-sales" class="max-w-[1600px] w-full mx-auto px-2 md:px-2 md:px-4 xl:px-[70px]">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3545593243-0', $__key);
...
?>
            ...
            <div class="relative group">
                ...
                <div class="absolute left-0 md:left-2 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="showLeft">
                    <button @click="scrollLeft" 
                            style="animation: float-pulse 2s infinite ease-in-out;"
                            class="w-8 h-8 md:w-10 md:h-10 flex items-center justify-center bg-white rounded-full shadow-[0_0_10px_rgba(0,0,0,0.15)] border border-gray-200 text-gray-600 hover:text-[var(--color-trust-blue)]">
                ...
                <div class="absolute right-0 md:right-2 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="showRight">
    ...
    <section class="max-w-[1600px] w-full mx-auto px-2 md:px-2 md:px-4 xl:px-[70px]">
...
<?php endif; ?>
    ...
    <section class="max-w-[1600px] w-full mx-auto px-2 block md:hidden"
             x-data="{
                activeSlide: 0,
        ...
        <div class="relative overflow-hidden group"
            ...
            <div class="absolute left-0 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="totalSlides > 1 && activeSlide > 0">
                <button @click="prev" 
                        style="animation: float-pulse 2s infinite ease-in-out;"
                        class="w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md border border-gray-200 text-gray-600">
                                ...
                                <a href="<?php echo e(route('shop', ['brand' => $brand->slug])); ?>" 
                                   class="bg-white rounded-xl border border-gray-100 shadow-sm transition-all p-2 flex items-center justify-center aspect-square group">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($brand->logo): ?>
                                        <img src="<?php echo e(asset('storage/' . ltrim($brand->logo, '/'))); ?>" alt="<?php echo e($brand->name); ?>" class="max-h-full max-w-full object-contain group-hover:scale-105 transition-transform">
                                    <?php else: ?>
            ...
            <div class="absolute right-0 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="totalSlides > 1 && activeSlide < totalSlides - 1">
                <button @click="next" 
                        style="animation: float-pulse 2s infinite ease-in-out;"
                        class="w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-md border border-gray-200 text-gray-600">
    ...
    <section class="max-w-[1600px] w-full mx-auto px-4 xl:px-[70px] hidden md:block"
        ...
        <div class="relative overflow-hidden group">
            ...
            <div class="absolute left-2 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="totalSlides > 1 && activeSlide > 0">
                <button @click="prev" 
                        style="animation: float-pulse 2s infinite ease-in-out;"
                        class="w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md border border-gray-200 text-gray-600 hover:text-[var(--color-trust-blue)]">
            ...
            <div class="absolute right-2 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="totalSlides > 1 && activeSlide < totalSlides - 1">
                <button @click="next" 
                        style="animation: float-pulse 2s infinite ease-in-out;"
                        class="w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-md border border-gray-200 text-gray-600 hover:text-[var(--color-trust-blue)]">
    ...
    <section class="max-w-[1600px] w-full mx-auto px-2 block md:hidden"
        ...
        <div class="relative overflow-hidden group"
            ...
            <div class="absolute left-0 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="totalSlides > 1 && activeSlide > 0">
                <button @click="prev" 
                        style="animation: float-pulse 2s infinite ease-in-out;"
                        class="w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-[0_0_10px_rgba(0,0,0,0.15)] border border-gray-200 text-gray-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                </button>
            </div>
    ...
    <section class="max-w-[1600px] w-full mx-auto px-4 xl:px-[70px] hidden md:block"
        ...
        <div class="relative overflow-hidden group">
            ...
            <div class="absolute left-2 top-1/2 -translate-y-1/2 z-10" x-cloak x-show="totalSlides > 1 && activeSlide > 0">
                <button @click="prev" 
                        style="animation: float-pulse 2s infinite ease-in-out;"
                        class="w-10 h-10 flex items-center justify-center bg-white rounded-full shadow-[0_0_10px_rgba(0,0,0,0.15)] border border-gray-200 text-gray-600 hover:text-[var(--color-trust-blue)]">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                </button>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views/home.blade.php ENDPATH**/ ?>