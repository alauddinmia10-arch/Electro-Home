...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1625546693-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1625546693-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1625546693-2', $__key);
...
?>
    ...
    <footer class="bg-[var(--color-text-primary)] text-white mt-auto">
        <div class="max-w-[1600px] w-full mx-auto px-2 md:px-4 xl:px-[70px] py-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-400">
                        <li class="flex items-center gap-2">
                            ...
                            <a href="https://wa.me/8801880223099" target="_blank" rel="noopener noreferrer" class="hover:text-white transition-colors">
                                +8801880223099
                            </a>
                        </li>
                        <li class="flex items-center gap-2">
...
<?php /**PATH C:\Users\MD ALAUDDIN\Desktop\MY Site 1\ElectroHome.BD\ElectroHome.BD\resources\views/layouts/app.blade.php ENDPATH**/ ?>