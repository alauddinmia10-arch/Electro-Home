...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            <h3 class="text-sm font-medium text-gray-700 border-b border-gray-200 pb-3 mb-6">Questions answered by Electro.bd (<?php echo e($totalQuestions); ?>)</h3>
                    ...
                    <div class="pb-6 border-b border-gray-100 last:border-b-0">
                        ...
                        <div class="flex items-start gap-3 ml-2 pl-4 border-l-2 border-gray-200">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500">By <span class="font-medium text-gray-700">Electro.bd</span> on <?php echo e($question->updated_at->format('d M Y')); ?></p>
                            </div>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
...
</div><?php /**PATH C:\Users\Hafeez Hameed\.gemini\antigravity-ide\scratch\electro-bd\resources\views\livewire\product-questions.blade.php ENDPATH**/ ?>