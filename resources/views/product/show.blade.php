            ...
            <div x-data="{ mainImage: '{{ $product->cover_image_url }}' }" class="lg:col-span-5 flex flex-col md:flex-row gap-3 md:gap-0 -ml-2 lg:-ml-6">
                ...
                @if($product->images && $product->images->count() > 0)
                    <div class="order-2 md:order-1 w-full md:w-[80px] shrink-0" x-data="{
                        ...
                        <div class="relative bg-white md:bg-transparent rounded-none md:rounded py-0 px-[14px] md:p-0 shadow-none border-y border-gray-100 md:border-none flex flex-col justify-start">
                            <!-- Prev Arrow (Up) -->
