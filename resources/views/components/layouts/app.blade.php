            ...
            <div class="max-w-[1440px] mx-auto px-4 xl:px-[70px]">
                <div class="flex items-center gap-6 h-9 text-sm">
                    <div x-data="{ open: false, activeCat: null, activeSubcat: null, flyoutTop: 0 }" @mouseenter="open = true" @mouseleave="open = false; activeCat = null; activeSubcat = null" class="relative h-full flex items-center">
                        <button class="bg-white border border-gray-200/90 rounded-full p-1 pr-4 flex items-center gap-2.5 shadow-sm hover:shadow transition-all text-gray-800 font-bold text-sm md:text-base">
                            <div class="w-8 h-8 md:w-9 md:h-9 rounded-full bg-[#0a9347] flex items-center justify-center text-white shrink-0 shadow-sm">
