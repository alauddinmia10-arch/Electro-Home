...
<div class="relative w-full" x-data="{ show: true }" @click.outside="show = false">
    <div class="relative">
        ...
        >
        <button type="button" class="absolute right-2 top-1/2 -translate-y-1/2 text-[#0a9347] p-1.5 rounded-full hover:bg-green-50 hover:scale-110 transition-all duration-200">
            ...
            <svg wire:loading class="w-5 h-5 animate-spin text-[#0a9347]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
