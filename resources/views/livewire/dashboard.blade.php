            ...
            <div class="w-full md:w-1/4">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden sticky top-20">
                    ...
                    <div class="flex flex-col p-2">
                        <a href="{{ route('dashboard') }}" class="px-4 py-3 text-trust-blue font-medium bg-blue-50 rounded-lg flex items-center gap-3">
                        ...
                        <a href="{{ route('wishlist') }}" class="px-4 py-3 text-gray-600 hover:text-trust-blue hover:bg-gray-50 rounded-lg flex items-center gap-3 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                            উইশলিস্ট
                        </a>
                        
                        @if(Auth::user()->isStaff())
                            <a href="{{ url('/admin') }}" class="px-4 py-3 text-trust-blue font-bold hover:bg-gray-50 rounded-lg flex items-center gap-3 transition-colors">
