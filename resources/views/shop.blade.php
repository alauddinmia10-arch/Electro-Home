                ...
                <div class="flex items-center justify-between bg-white p-1.5 md:p-3 rounded border border-gray-100 shadow-sm mb-6">
                    <div class="flex items-center gap-2 md:gap-3">
                        ...
                        <div class="flex items-center border border-gray-200 rounded overflow-hidden bg-gray-50">
                            <a href="{{ request()->fullUrlWithQuery(['view' => 'grid']) }}" class="p-1.5 md:p-2 {{ request('view', 'grid') === 'grid' ? 'bg-[#0b5c9a] text-white' : 'text-gray-500 hover:bg-gray-100' }}" title="Grid View">
                            ...
                            <a href="{{ request()->fullUrlWithQuery(['view' => 'list']) }}" class="p-1.5 md:p-2 {{ request('view') === 'list' ? 'bg-[#0b5c9a] text-white' : 'text-gray-500 hover:bg-gray-100' }}" title="List View">
