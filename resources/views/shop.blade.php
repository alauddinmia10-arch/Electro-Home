<x-layouts.app>
    <div x-data="{ showMobileFilters: false }" class="max-w-[1600px] w-full mx-auto px-3 md:px-6 xl:px-[70px] pt-2 pb-4 md:py-8">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="flex-1">
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-2 md:mb-4">
                    <div>
                ...
                {{-- Toolbar (View, Columns, Sort) --}}
                <div class="flex items-center justify-between bg-white p-1.5 md:p-3 rounded border border-gray-100 shadow-sm mb-3 md:mb-6">
                    <div class="flex items-center gap-2 md:gap-3">
                        {{-- Mobile Filter Button --}}
                        <button type="button" @click="showMobileFilters = true" class="md:hidden flex items-center gap-1 px-2.5 py-2 bg-gray-50 border border-gray-200 rounded text-[13px] font-medium text-gray-700 hover:bg-gray-100">
                    ...
                    <div class="flex items-center gap-2 md:gap-4">
                        ...
                        <form id="sort-form" class="flex items-center gap-1.5 md:gap-2">
                            ...
                            <select name="sort_order" onchange="document.getElementById('sort-form').submit()" class="text-[12px] md:text-sm bg-white border border-gray-200 rounded px-1.5 py-2 md:px-3 focus:outline-none focus:border-[#0b5c9a] text-gray-700 shadow-sm cursor-pointer hover:border-gray-300">
                                <option value="desc" {{ request('sort_order', 'desc') === 'desc' ? 'selected' : '' }}>{{ $descLabel }}</option>
                                <option value="asc" {{ request('sort_order', 'desc') === 'asc' ? 'selected' : '' }}>{{ $ascLabel }}</option>
                            </select>
                        </form>
