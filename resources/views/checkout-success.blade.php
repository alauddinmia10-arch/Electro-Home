...
<div class="bg-gray-100 py-2 md:py-6">
    <div class="max-w-[1440px] mx-auto px-2 md:px-4 xl:px-[70px] flex justify-center items-start">
        <div class="w-full max-w-2xl bg-white rounded-md shadow-sm border border-gray-200 p-3 md:p-6 flex flex-col justify-center text-center">
            ...
            <div class="text-2xl md:text-3xl text-gray-600 mb-4 leading-tight flex flex-col items-center gap-2">
                ...
                <span class="text-xl md:text-2xl font-semibold text-black">{{ $order->invoice_number }}</span>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center mt-2">
                @guest
                    <a href="{{ route('login') }}" class="btn btn-primary bg-[var(--color-trust-blue)] text-white px-8 py-4 rounded hover:brightness-90 hover:bg-[var(--color-trust-blue)] border-none transition font-bangla text-3xl md:text-4xl w-full sm:w-auto">লগইন করুন</a>
                @endguest
                @auth
                    <a href="{{ route('dashboard') }}" class="btn btn-primary bg-[var(--color-trust-blue)] text-white px-8 py-4 rounded hover:brightness-90 hover:bg-[var(--color-trust-blue)] border-none transition font-bangla text-3xl md:text-4xl w-full sm:w-auto">ড্যাশবোর্ড</a>
                @endauth
                <a href="{{ route('home') }}" class="btn bg-green-600 text-white border-none px-8 py-4 rounded hover:brightness-90 hover:bg-green-600 transition font-bangla text-3xl md:text-4xl shadow-sm w-full sm:w-auto">হোমে ফিরে যান</a>
            </div>
        </div>
    </div>
</div>
