...
<div class="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-gray-100 px-8 pt-8 md:px-12 md:pt-10 flex flex-col justify-center text-center" style="padding-bottom: 24px;">
        ...
        <div class="bg-blue-50 rounded-xl p-6 mb-4 text-lg md:text-xl text-blue-800 font-bangla font-medium leading-relaxed">
